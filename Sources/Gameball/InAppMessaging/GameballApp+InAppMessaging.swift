...
final class InAppMessagingCoordinator {
    ...
    private func registerLifecycleObservers() {
        ...
        // A rotation is a display opportunity: a fullscreen authored for one orientation
        // waits in the deferred stack until the device matches it.
